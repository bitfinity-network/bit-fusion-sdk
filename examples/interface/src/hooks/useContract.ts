...
import { FaucetContract } from 'abis/types/FaucetContract'
...
export function useFaucetContract() {
  const FAUCET_ADDRESS = useContext(FaucetContext)
  const FAUCET_ADDRESSES: AddressMap = {
    [SupportedChainId.BITFINITY]: FAUCET_ADDRESS,
  }
