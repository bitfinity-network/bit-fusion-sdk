...
export const MAIN_CARDS = [
  {
    to: '/swap',
    title: 'Swap tokens',
    description: 'Buy, sell, and explore tokens on the Internet Computer EVM Testnet',
    cta: 'Trade Tokens',
  ...
  },
  {
    to: '/pool',
    title: 'Add Liquidity',
    description: 'Add liquidity to our pools on the Internet Computer EVM Testnet',
    cta: 'Add Liquidity',
    darkBackgroundImgSrc: swapCardImgSrc,
    lightBackgroundImgSrc: swapCardImgSrc,
