...
docker exec -it ord-cli ord --regtest --bitcoin-rpc-url bitcoind:18443 wallet inscribe --fee-rate 1 --file /brc20_json_inscriptions/brc20_mint.json --destination $WALLET_ADDRESS
