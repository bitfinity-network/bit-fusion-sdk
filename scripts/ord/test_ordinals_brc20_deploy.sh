...
docker exec -it ord-cli ord --regtest --bitcoin-rpc-url bitcoind:18443 wallet --server-url http://ord:1338 inscribe --fee-rate 1 --file /brc20_json_inscriptions/brc20_deploy.json
