...
bitcoin-core.cli -conf="${PWD}/src/create_bft_bridge_tool/bitcoin.conf" generatetoaddress 1 "$address"
...
BTC_ADDRESS=$(bitcoin-core.cli -conf="${PWD}/src/create_bft_bridge_tool/bitcoin.conf" getnewaddress)
