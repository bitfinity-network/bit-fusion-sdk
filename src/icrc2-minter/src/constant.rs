...
pub const OPERATIONS_MEMORY_ID: MemoryId = MemoryId::new(87);
pub const OPERATIONS_LOG_MEMORY_ID: MemoryId = MemoryId::new(88);
pub const OPERATIONS_MAP_MEMORY_ID: MemoryId = MemoryId::new(89);
