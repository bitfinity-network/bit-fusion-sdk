...
const ORD_SERVER_URL: &str = "http://localhost:8000";
...
impl Brc20TestContext {
    async fn new() -> Self {
        ...
        let brc20_bridge_config = Brc20BridgeConfig {
            ...
            admin: context.admin(),
            deposit_fee: 500_000,
            general_indexer: "https://localhost:8001".to_string(),
            brc20_indexer: "https://localhost:9001".to_string(),
            logger: LogSettings {
                enable_console: true,
