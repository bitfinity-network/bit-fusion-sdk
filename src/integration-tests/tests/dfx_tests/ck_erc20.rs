...
impl UniswapEnv {
    ...
    pub async fn new(ctx: &DfxTestContext, owner: &Wallet<'_, SigningKey>) -> Self {
    ...
    async fn create_factory(ctx: &DfxTestContext, owner: &Wallet<'_, SigningKey>) -> H160 {
    ...
    async fn create_token(ctx: &DfxTestContext, owner: &Wallet<'_, SigningKey>) -> H160 {
