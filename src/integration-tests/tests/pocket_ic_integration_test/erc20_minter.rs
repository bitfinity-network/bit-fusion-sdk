...
use minter_contract_utils::bft_bridge_api::NATIVE_TOKEN_BALANCE;
use minter_contract_utils::bft_bridge_api::{self, decode_burn_operation_id, NATIVE_TOKEN_DEPOSIT};
