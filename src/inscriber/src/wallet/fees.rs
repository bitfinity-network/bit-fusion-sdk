...
mod tests {
    ...
    #[test]
    fn calculate_transaction_fees_p2wsh_single_signature() {
        ...
        let fee = calculate_transaction_fees(
            script_type,
            unsigned_tx_size,
            current_fee_rate,
            multisig_config,
    ...
    #[test]
    fn calculate_transaction_fees_p2wsh_multisig() {
        let script_type = ScriptType::P2WSH;
    ...
    #[test]
    fn calculate_transaction_fees_p2tr() {
    ...
    #[test]
    #[should_panic]
    fn calculate_transaction_fees_overflow() {
        let script_type = ScriptType::P2TR;
        let unsigned_tx_size = usize::MAX;
        let current_fee_rate = FeeRate::from_sat_per_vb(1_u64).unwrap();
        let multisig_config = None;

        let _fee = calculate_transaction_fees(
            script_type,
            unsigned_tx_size,
            current_fee_rate,
            multisig_config,
    ...
    #[test]
    fn calculate_transaction_fees_low_fee_rate() {
        let script_type = ScriptType::P2WSH;
    ...
    #[test]
    fn calculate_transaction_fees_high_fee_rate() {
        let script_type = ScriptType::P2TR;
    ...
    #[test]
    fn calculate_transaction_fees_varying_fee_rate() {
        let script_type = ScriptType::P2WSH;
