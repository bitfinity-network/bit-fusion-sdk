...
contract DeployWrappedToken is Script {
    function run() external {
        ...
        address wrappedTokenDeployerAddress = vm.envAddress("WRAPPED_TOKEN_DEPLOYER");
        ...
        IWrappedTokenDeployer wrappedTokenDeployer = IWrappedTokenDeployer(wrappedTokenDeployerAddress);

        // Deploy ERC20 token
        address tokenAddress = wrappedTokenDeployer.deployERC20(name, symbol, decimals, owner);
